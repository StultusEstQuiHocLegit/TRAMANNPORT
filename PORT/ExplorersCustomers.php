<h1>👥 EXPLORERS (CUSTOMERS)</h1>

<?php
$preselectedOption = "your_explorers_customers"; // add preselected search option
...
// Div for listing all explorers (customers)
echo "<div id=\"listExplorersCustomersDiv\" class=\"steps\">";

// Function to display a creators and explorers row
function displayExplorersCustomersow($product, $highlight = false, $user_id = null) {
...
while ($product = $stmt->fetch(PDO::FETCH_ASSOC)) {
    displayExplorersCustomersow($product, false, $user_id);
}
echo '</table>';
